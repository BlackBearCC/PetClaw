...
describe("infra parsing", () => {
  ...
  describe("isMainModule", () => {
    ...
    it("returns true for dist/entry.js when launched via petclaw.mjs wrapper", () => {
      expect(
        isMainModule({
          currentFile: "/repo/dist/entry.js",
          argv: ["node", "/repo/petclaw.mjs"],
          cwd: "/repo",
          env: {},
          wrapperEntryPairs: [{ wrapperBasename: "petclaw.mjs", entryBasename: "entry.js" }],
        }),
      ).toBe(true);
    });
