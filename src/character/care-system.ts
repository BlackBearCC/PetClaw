...
export const PLAY_ACTIONS: PlayAction[] = [
  { id: "pet_stroke",       name: "抚摸",             effects: { mood: 4, intimacy: 1 } },
  { id: "无限非概率逗猫器", name: "无限非概率逗猫器", effects: { mood: 8, hunger: -5, intimacy: 2 } },
  { id: "hide_seek",        name: "捉迷藏",           effects: { mood: 10, hunger: -8, intimacy: 3 } },
  { id: "sunbathe",         name: "晒太阳",           effects: { mood: 5, hunger: -2, intimacy: 1 } },
];
